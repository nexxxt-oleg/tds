document.addEventListener("DOMContentLoaded", () => {
    ...
    if (document.getElementById('anchorSlider')) {
        new Swiper('#anchorSlider', {
            slidesPerView: 'auto',
            spaceBetween: 25,
    ...
    if (document.getElementById('sliderProduct')) {
        let swiperMin = new Swiper("#sliderProductMini", {
            ...
            navigation: {
                nextEl: '#sliderProductMiniNext',
                prevEl: '#sliderProductMiniPrev',
            },
        });
    ...
    if (window.screen.width < 574) {
        ...
        const blockToSticky = document.querySelector('.main-content__left');
        if (blockToSticky) {
            const blockToStickyTop = blockToSticky.getBoundingClientRect().top;

            function handleScroll() {
                const scrollPosition = window.pageYOffset || document.documentElement.scrollTop;
                if (scrollPosition >= blockToStickyTop) {
                    blockToSticky.classList.add('fix');
                } else {
                    blockToSticky.classList.remove('fix');
                }
            }
    ...
    if (document.getElementById('priceRange2')) {
        let priceRange = document.getElementById('priceRange2');
    ...
    window.activeSlideCompare = function () {
    ...
    function sinfroCompareRow() {
        ...
        let laptopScreen = window.matchMedia('(max-width: 991px)');

        if (laptopScreen.matches) {
            let rowTopCompare = [].slice.call(document.querySelectorAll('.js-compare-props .compare-props'));
            rowTopCompare.forEach(function (e) {
    ...
    function topCompareNavMob() {
        let mobCoord = document.querySelector('#compareSlider .swiper-slide:nth-child(1) .card-product__link').clientHeight + 'px';
        document.getElementById('compareSliderNav1').style.top = mobCoord;
        document.getElementById('compareSliderNav2').style.top = mobCoord;
        document.getElementById('mobFilterCompare').style.top = mobCoord;
    }
    ...
    if (document.getElementById('compareSlider')) {
        ...
        let compareSlider2 = new Swiper('#compareSlider2', {
            navigation: {
                nextEl: '#compareSliderNext2',
                prevEl: '#compareSliderPrev2',
            },
            spaceBetween: 10,
            slidesPerView: 1,
            pagination: {
                el: "#compareSliderPage2",
                type: "custom",
                renderCustom: function (swiper, current, total) {
                    return current + ' из ' + total;
                },
    ...
    window.updateSticky = function () {
        if (window.screen.width > 991) {
            if (document.getElementById('catalogSb') || document.getElementById('order_form_content')) {

                $('.main-content__left').theiaStickySidebar({
    ...
    /*
      if (window.screen.width > 768) {
          let catalogList = document.querySelectorAll('.catalog-list__col');
           if(catalogList.length > 0) {
               catalogList.forEach((item) => {
                   let itemCard = item.querySelector('.card-product');
                   let tempHeight = item.offsetHeight + 20;
                   item.style.height = tempHeight + 'px';
                   itemCard.style.minHeight = tempHeight + 'px';
                   item.classList.add('hover');
                  // item.querySelector('.card-product__link').style.height = tempHeight - 48 + 'px';
               });
           }
       }*/

    const scrollToTopBtn = document.getElementById('btnUp');
    ...
    if (document.getElementById('setModal')) {
        new Swiper('#setModal', {
            slidesPerView: 2,
            spaceBetween: 10,
            navigation: {
    ...
    const slider_col4 = document.querySelectorAll('.js-slider-col4');

    slider_col4.forEach(el => {
        let navPrev = el.parentNode.querySelector('.swiper-prev');
        let navNext = el.parentNode.querySelector('.swiper-next');
    ...
    if (document.getElementById('mobCatsFilter')) {
        new Swiper('#mobCatsFilter', {
            slidesPerView: 'auto',
            spaceBetween: 10,
        });
    }
    if (document.getElementById('brandLinkSlider')) {
        new Swiper('#brandLinkSlider', {
            slidesPerView: 'auto',
            spaceBetween: 30,
        });
    }
    ...
    if (document.getElementById('authModal')) {
        ...
        authModal.addEventListener('show.bs.modal', function (event) {
            ...
            const tabId = triggerElement ? triggerElement.getAttribute('data-tab') : null;
            if (tabId && document.getElementById(tabId)) {
                document.getElementById(tabId).click();
            } else {
                document.getElementById('tabAuthModal').click();
            }
            return true;
        });
    }

    if (document.getElementById('filterOrder')) {
        new Swiper('#filterOrder', {
            slidesPerView: 'auto',
            spaceBetween: 20,
            breakpoints: {
                300: {
    ...
    if (document.getElementById('mobNavCabinet') && window.screen.width < 992) {

        new Swiper('#mobNavCabinet', {
            slidesPerView: 'auto',
            spaceBetween: 25,
