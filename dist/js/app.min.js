    ...
    function sinfroCompareRow() {
        ...
        if (laptopScreen.matches) {
            rowCompare.forEach(function (e) {
                let sliderSelector = '#compareSlider .compare-page__nav-props__line.'+ e.dataset.sinhro;
                let paddingSlider = document.querySelector(sliderSelector);
                let sliderSelector2 = '#compareSlider2 .compare-page__nav-props__line.'+ e.dataset.sinhro;
                let paddingSlider2 = document.querySelector(sliderSelector2);
                let spanHeight = e.querySelector('span').clientHeight + "px"
                if(paddingSlider) {
                    //console.log(e.querySelector('span').clientHeight + "px");

                    paddingSlider.style.paddingTop = spanHeight;
                    //paddingSlider2.style.paddingTop = spanHeight;
                }
                //if(paddingSlider2) {
                    console.log(paddingSlider);
                //}
            });
        }
